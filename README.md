...
4. What are the different datatypes in C? Give examples.  
   ...
   b. Datatypes that are derived from the primitive types are known as <ins>Non-Primitive datatypes</ins>. e.g.- array, pointer.  
   c. Datatypes that are defined by the user to store the data accordingly are known as <ins>User-defined datatypes</ins>. e.g.- structure, union, enum.  
